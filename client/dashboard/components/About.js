    ...
    <Container>
      ...
      <Segment attached>
        ...
        <p>
          ...
          <em>Don't worry!</em>
          Pretty soon, our model will learn your ways, and then we'll only have
          to bother you every once in a while. We'll never stop bothering you
          completely, because Wirehead's motto is to always be learning, always
          be improving.
        </p>
        <p>
